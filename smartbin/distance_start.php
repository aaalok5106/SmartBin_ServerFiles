...
*/
	...
	$qry1 = "delete from all_combinations_installed_bins where bin_id_from = 'BINSTART'";
	$conn->query($qry1);				
	$qry2 = "delete from all_combinations_installed_bins where bin_id_to = 'BINSTART'";
	$conn->query($qry2);
...
$query3 = "select * from start_end_path_position where bin_id = 'BINSTART'";
